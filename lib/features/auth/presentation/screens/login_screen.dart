    ...
    try {
      ...
      if (result == "Login Successful") {
        ...
        if (firebaseUser != null) {
          ...
          final authProvider = Provider.of<auth_providers.AuthProvider>(context, listen: false);
          final token = await firebaseUser.getIdToken();
          authProvider.setUser(firebaseUser, token!);
          ...
          // Navigate directly to home instead of loader
